...
function setup() {
	...
	boy = createSprite(250,630,80,80);
	boy.addImage(boyIMG);
	boy.scale = 0.1

	stone = new Stone(270,570,100);
	...
	man1 = new Mango(620, 350, 40);
	man2 = new Mango(540, 300, 40);
	man3 = new Mango(680, 200, 40);
	man4 = new Mango(740, 280, 40);
	man5 = new Mango(630, 270, 40);

	tree = new Tree(700,700);

	ground = new Ground(400, 695, 900, 20);

	launcher = new Launcher(stone.body,{x: 200, y: 600});
